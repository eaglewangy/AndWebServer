...
public class WebServer extends Thread {
    ...
    private static final String WORKBOOK_PATTERN = "/workbook*";
	...
	public WebServer(Context context, NotificationManager notifyManager){
        ...
        registry.register(WORKBOOK_PATTERN, new FileHandler(context, serverPort));
	...
	public void run() {
		...
		try {
			...
			ServerSocket serverSocket = new ServerSocket(serverPort, 50, address);
